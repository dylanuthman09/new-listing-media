...
import { Arrow, ContactBand, MediaImage, SiteFooter, SiteHeader } from "../../components";
    ...
    <>
      <main id="main-content">
        <section className="article-hero">
          <SiteHeader overlay />
          <MediaImage src="/media/interior-living.webp" alt="Prepared living space ready for real estate media" fill sizes="100vw" priority />
          <div><h1>How to Prepare a Home for Media Day</h1></div>
        </section>
        <article className="article-body section-shell">
          ...
          <figure><MediaImage src="/media/residential-exterior.webp" alt="Residential exterior prepared for a media shoot" width={2000} height={1337} sizes="(max-width: 780px) 100vw, 125vw" loading="lazy" /><figcaption>Exterior preparation matters: clear vehicles, bins, hoses, and temporary items from primary views.</figcaption></figure>
          ...
          <div className="article-callout"><h3>Confirm access, occupancy, requested services, and any features that must be photographed.</h3></div>
